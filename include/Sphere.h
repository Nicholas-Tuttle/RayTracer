...
namespace RayTracer
{
	...
	public:
		...
		bool IntersectsRay(const IRay *incoming_ray, IIntersection *&out_intersection_info) const override
		{
			...
			out_intersection_info = new Intersection(depth, intersection_normal, intersection_location);
